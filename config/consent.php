...
return [
    ...
    | records that answer here, and nothing in config/google-ads.php loads until
    | the answer is yes. Read docs/privacy-and-legal.md before changing any of
    | this, because the cookie policy names the key below.
    |
    */
    ...
    */
    ...
    'version' => (string) env('CONSENT_VERSION', '2026-09-14'),
