...
<ul>
    <li>{{ __('Below 700 pixels wide, the market tables on Markets, your watchlist and DexScan become a list of rows that open in place, and where sorting lived in the column headers it moves into a select above the list. The figures are the same; the columns are stacked instead of side by side. Wider than that, a table pans sideways with the asset name held still.') }}</li>
